 ...
 */
package com.tosnos.cosa.binary.function.formatter;
...
public final class Formatter implements Closeable, Flushable {
     ...
     *
     * @param a Destination for the formatted output.  If <tt>a</tt> is
    ...
    public Formatter format(String format, NativeLibraryHandler handler, LibraryModule module, int paramIndex) {
        ensureOpen();
            ...
            try {
                switch (index) {
                    case -2:  // fixed string, "%n", or "%%"
                        fs.print(handler, module, null, l);
                        break;
                    ...
                    case 0:  // ordinary index
                        lasto++;
                        last = lasto;
                        fs.print(handler, module, handler.getValueOfParameter(paramIndex + lasto), l);
                        break;
...
//              System.out.println();
    ...
    private interface FormatString {
        ...
        void print(NativeLibraryHandler handler, LibraryModule module, Object arg, Locale l) throws IOException;
    ...
    private static class Conversion {
        ...
        static final char LONG_INTEGER = 'l';
...
// *        case LOCALE_DATE:
    ...
    private class FixedString implements FormatString {
        ...
        public void print(NativeLibraryHandler handler, LibraryModule module, Object arg, Locale l)
                throws IOException {
            a.append(s);
        }
    ...
    private class FormatSpecifier implements FormatString {
        ...
        public void print(NativeLibraryHandler handler, LibraryModule module, Object arg, Locale l) throws IOException {
            if (dt) {
                printDateTime(arg, l);
                return;
            }
            switch (c) {
                ...
                case Conversion.HEXADECIMAL_INTEGER:
                    printInteger(((AbstractValue) arg).intValue(), l);
                    break;
                ...
                case Conversion.CHARACTER_UPPER:
                    printCharacter(((AbstractValue) arg).intValue().byteValue());
                    break;
                ...
                case Conversion.STRING:
                    try {
                        printString(Function.getStringValue(module, (AbstractValue) arg), l);
                    } catch (Z3Exception e) {
                        e.printStackTrace();
        ...
        private void printString(Object arg, Locale l) throws IOException {
            if (arg == null) {
                ...
                ((Formattable) arg).formatTo(new java.util.Formatter(formatter.out(), l), f.valueOf(), width, precision);
            } else {
                print(arg.toString());
            }
        }
